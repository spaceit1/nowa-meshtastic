export const en = {
    ...
    addUserTemplate: "Add User Template",
    editUserTemplate: "Edit User Template",
    deleteUserTemplate: "Delete User Template",
    deleteUserTemplateConfirmation: "Are you sure you want to delete this user template?",
    userTemplateAdded: "User template has been added",
    userTemplateUpdated: "User template has been updated",
    userTemplateDeleted: "User template has been deleted",
    errorAddingUserTemplate: "Error adding user template",
    errorUpdatingUserTemplate: "Error updating user template",
    errorDeletingUserTemplate: "Error deleting user template",
    errorFetchingUserTemplates: "Error fetching user templates",
    noUserTemplatesFound: "No user templates found",
    noUserTemplatesFoundDescription: "No user templates found. Add your first template.",
